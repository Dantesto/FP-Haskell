...
evaluate (UnNode (Operator "+" _ _) node) variable = evaluate node variable
evaluate (UnNode (Operator "-" _ _) node) variable = -(evaluate node variable)
...
evaluate (BinNode (Operator "+" _ _) lNode rNode) variable = (evaluate lNode variable) + (evaluate rNode variable)
evaluate (BinNode (Operator "-" _ _) lNode rNode) variable = (evaluate lNode variable) - (evaluate rNode variable)
evaluate (BinNode (Operator "*" _ _) lNode rNode) variable = (evaluate lNode variable) * (evaluate rNode variable)
evaluate (BinNode (Operator "/" _ _) lNode rNode) variable = (evaluate lNode variable) / (evaluate rNode variable)
evaluate (BinNode (Operator "^" _ _) lNode rNode) variable = (evaluate lNode variable) ** (evaluate rNode variable)
